        ...
        <div class="site-menus" :class="{'mobileShow':mobileShow}" @click.stop="mobileShow=!mobileShow">
            ...
            <div class="menu-item hasChild">
                ...
                <div class="childMenu" v-if="category.length">
                    <div class="sub-menu" v-for="item in category" :key="item.title"><router-link :to="`/category/${item.categoryId}`">{{item.categoryName}}</router-link></div>
                </div>
            </div>
