    ...
    <div id="layout-footer">
        <div class="footer-main">
            ...
            <div class="footer-item">
                ...
                <div><a target="_blank" class="out-link" href="/admin">☞后台管理</a></div>
            </div>
        </div>
        <!-- <div class="copyright">Copyright © 2023 by <a target="_blank" class="out-link" href="https://www..cn">guanlyee.top</a> . All rights reserved. | <a target="_blank" class="out-link" href="http://www.beian.miit.gov.cn">ICP备17015355号-1</a></div> -->
    </div>
</template>
